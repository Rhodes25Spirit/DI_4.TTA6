...
This method returns a string stating which dog won the fight. The winner should be
the dog with the higher run_speed x weight. Create 3 dogs and run them through your class.'''
...
and the value should be False by default. Add the following methods:
